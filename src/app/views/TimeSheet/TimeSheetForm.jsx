...
export default observer(function TimeSheetForm() {
  ...
  const { shouldOpenEditorDialog, setShouldOpenEditorDialog, selected, updateData, saveData, getById } = timeSheetStore;
  ...
  return (
    <Dialog
      ...
      maxWidth={"md"}
    >
      <DialogTitle id="alert-dialog-title">{selected?.id ? "Edit Time Sheet" : "Create Time Sheet"}</DialogTitle>
      <DialogContent>
        <Formik
            ...
            <Form>
              <div className={classes.wapper}>
                ...
                <Autocomplete
                  multiple
                  options={
                    Array.isArray(projectStore?.selected?.projectStaff) ? projectStore?.selected?.projectStaff : []
                  }
